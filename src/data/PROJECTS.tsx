...
const projects: Project[] = [
  {
    ...
    description: () => {
      return (<>
        ...
        <h5 className="font-bold mt-4">An important note</h5>
        ...
        <p>Anyways, the point is that the components the this program gives for a certain character are based on the way it is written in MODERN simplified Chinese. For this reason, keep in mind that some components contribute nothing to the character as a whole: they simply exist in the modern character because they look like something else that historically made up that character. The main reason for this is that the purpose of the program is to aid Chinese learners in identifying and writing characters by breaking them down into components, rather than to teach people about the etymology of the characters. An additional reason is that I would like to include this information, but it's a lot of work to do for every character.</p>
        <h5 className="font-bold mt-4">Some technical details</h5>
